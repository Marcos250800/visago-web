...
const CARDS: Card[] = [
  ...
  },
  {
    ...
    desc: "Explora el globo y descubre las universidades públicas de España.",
    href: "/mapa-interactivo",
    image: "/showcase/mapa-interactivo.jpg",
  },
  {
    kicker: "Recurso · Máster",
    title: "Guía Máster",
    desc: "Estudiar un máster oficial en universidades públicas de España.",
    href: "/guia-master",
    image: "/showcase/guia-master.jpg",
  },
  {
    kicker: "Recurso · FP",
    title: "Guía FP",
    desc: "Formación Profesional de Grado Superior en España.",
    href: "/guia-fp",
    image: "/showcase/guia-fp.jpg",
  },
  {
    kicker: "Recurso · Instagram",
    title: "Dudas en un minuto",
    desc: "Resuelve dudas frecuentes en un minuto, en Instagram.",
    href: "/recursos",
    image: "/showcase/dudas.jpg",
  },
  {
    kicker: "Empieza hoy",
  ...
  return (
    ...
    >
      ...
      <div className="py-20 lg:sticky lg:top-0 lg:flex lg:h-[100svh] lg:flex-col lg:justify-center lg:overflow-hidden">
        ...
        {/* MÓVIL: swipe horizontal con el dedo + Tilt 3D al tocar (como en PC).
            Tilt aporta el contexto de apilamiento que hace visible la imagen. */}
        <div className="no-scrollbar mt-8 flex snap-x snap-mandatory gap-4 overflow-x-auto px-5 pb-3 lg:hidden">
          {CARDS.map((card) => (
            <Tilt key={card.title} className={`${wrapCls} snap-center`} max={6}>
              <CardLink card={card} />
            </Tilt>
          ))}
        </div>

...
/**
 * Malla parpadeante (canvas) — textura "inorgánica" sutil de fondo.
 * Adaptado de Magic UI (flickering-grid) a nuestro stack + theme-aware.
 */
...
export const FlickeringGrid: React.FC<FlickeringGridProps> = ({
  ...
  const resolvedColor = color ?? (theme === "light" ? "rgb(10,10,11)" : "rgb(244,244,243)");
